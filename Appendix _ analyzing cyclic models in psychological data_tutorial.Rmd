---
title: 'Analysing cyclic models in psychological data: a tutorial'
...
This brief appendix illustrates how the functions used in the manuscript can be used.
...
We start by installing and loading the package "userfriendlyscience":
...
But we first start with a constructed data set and plot these data using ggplot2 library.
