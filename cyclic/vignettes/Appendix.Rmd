...
&nbsp;
As an illustration of a cyclic process we generate perfect cyclic data and construct Figure 1 with these data using the following code. The package ggplot2 (loaded with "cyclic") is used for plotting. 
