...
## Appendix of tutorial analyzing cyclic models
...
The "smoking" data are read from the .csv file or from the SPSS .sav file, named SmokingLapse.sav. With the getData function (from the "userfriendlyscience" package) we can select the .sav file from the computer. Check the names in the dataframe.
...
The raw data for three subjects and average are plotted. This makes Figure 1 from the tutorial.
...
Apply, only for subject 15, the cylic model with a weekly period for stress and positive affect, instead of a daily period. This is shown in Figure 4.
...
Compute additional fit values and make plot of most complex model for aggregated data (Figure 5 in the tutorial).
