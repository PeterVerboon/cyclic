...
author: "Peter Verboon & Roeslan Leontjevas"
date: "April, 18, 2018"
...
a <- fitCyclic(pdat, form= "y ~ cvar + svar  ",yvar = "intention", xvar="beepnr", dayNumber = "daynr", ymin = -1.0, ymax = 0.5, step= 0.25)
...
out <- fitCyclic(pdat, form= "y ~ cvar + svar  ",yvar = "stress", xvar="daynr", ymin = -2.0, ymax = 1.0, step= 0.25)
